...
struct qt_meta_stringdata_CLASSGlobalENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSGlobalENDCLASS = QtMocHelpers::stringData(
    "Global"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSGlobalENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject Global::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSGlobalENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSGlobalENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSGlobalENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *Global::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSGlobalENDCLASS.stringdata0))
