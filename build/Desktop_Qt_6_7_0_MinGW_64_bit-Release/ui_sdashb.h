...
"}"));
        ...
        Eval->setGeometry(QRect(180, 90, 121, 31));
        QFont font8;
...
"}"));
        ...
        Semester->setGeometry(QRect(20, 40, 231, 31));
        Semester->setFont(font6);
...
""));
    ...
    void retranslateUi(QMainWindow *Sdashb)
    {
        ...
        Eval->setText(QCoreApplication::translate("Sdashb", "ONGOING", nullptr));
        EditButton->setText(QCoreApplication::translate("Sdashb", "Edit Profile", nullptr));
        Semester->setText(QCoreApplication::translate("Sdashb", "<html><head/><body><p>Second Semester</p></body></html>", nullptr));
