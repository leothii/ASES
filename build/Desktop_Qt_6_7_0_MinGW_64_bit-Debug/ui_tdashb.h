...
""));
        ...
        Semester = new QLabel(groupBox_2);
        Semester->setObjectName("Semester");
        Semester->setGeometry(QRect(20, 10, 361, 31));
        Semester->setFont(font12);
        Semester->setStyleSheet(QString::fromUtf8("color: rgb(0, 0, 0);"));
        Semester->setWordWrap(true);
        Eval = new QLabel(groupBox_2);
        Eval->setObjectName("Eval");
        Eval->setGeometry(QRect(200, 90, 101, 41));
        QFont font13;
...
"}"));
        ...
        description = new QLabel(groupBox_3);
        description->setObjectName("description");
        description->setGeometry(QRect(230, 110, 171, 16));
        description->setFont(font6);
        description->setStyleSheet(QString::fromUtf8("color: rgb(0, 0, 0);"));
        groupBox_4 = new QGroupBox(groupBox_3);
        groupBox_4->setObjectName("groupBox_4");
        groupBox_4->setGeometry(QRect(20, 140, 231, 71));
        ...
        viewButton->setGeometry(QRect(80, 230, 121, 31));
...
"MAIN CAMPUS", nullptr));
        ...
        AcadYear->setText(QCoreApplication::translate("Tdashb", "<html><head/><body><p>Second Semester</p></body></html>", nullptr));
        Semester->setText(QCoreApplication::translate("Tdashb", "<html><head/><body><p>Academic Year: 2024-2025<br/></p></body></html>", nullptr));
        Eval->setText(QCoreApplication::translate("Tdashb", "ONGOING", nullptr));
        ...
        description->setText(QCoreApplication::translate("Tdashb", "OUTSTANDING", nullptr));
