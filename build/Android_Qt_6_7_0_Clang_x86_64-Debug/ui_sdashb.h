...
public:
    ...
    QLabel *label_6;
    QGroupBox *groupBox;
    QPushButton *startEvalButton;
    QLabel *AcadYear;
    QLabel *StatusBar;
    QLabel *label;
    QPushButton *courseTeachButton;
    QLabel *AcadYear_2;
    QLabel *label_3;
    QLabel *label_4;
    QFrame *line;
...
"border-radius: 10px;"));
        startEvalButton = new QPushButton(groupBox);
        startEvalButton->setObjectName("startEvalButton");
        startEvalButton->setGeometry(QRect(140, 140, 101, 31));
        QFont font5;
        font5.setFamilies({QString::fromUtf8("Product Sans Light")});
        font5.setPointSize(10);
        startEvalButton->setFont(font5);
        startEvalButton->setStyleSheet(QString::fromUtf8("QPushButton {\n"
"    background-color: #337ab7;  /* Button background color (blue) */\n"
"    color: #ffffff;             /* Text color (white) */\n"
"	border-radius: 3px;\n"
"}\n"
...
"}"));
        ...
        courseTeachButton = new QPushButton(groupBox);
        courseTeachButton->setObjectName("courseTeachButton");
        courseTeachButton->setGeometry(QRect(10, 140, 111, 31));
        courseTeachButton->setFont(font5);
        courseTeachButton->setStyleSheet(QString::fromUtf8("QPushButton {\n"
"    background-color: #337ab7;  /* Button background color (blue) */\n"
"    color: #ffffff;             /* Text color (white) */\n"
"	border-radius: 3px;\n"
"}\n"
...
"}"));
    ...
    void retranslateUi(QMainWindow *Sdashb)
    {
        ...
        startEvalButton->setText(QCoreApplication::translate("Sdashb", "Evaluate", nullptr));
        ...
        courseTeachButton->setText(QCoreApplication::translate("Sdashb", "Edit Profile", nullptr));
