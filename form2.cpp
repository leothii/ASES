    ...
    , ui(new Ui::Form2)
{
    ...
    connectRadioButtons();
    connect(ui->nextButton, &QPushButton::clicked, this, &Form2::on_nextButton_clicked);
...
void Form2::connectRadioButtons()
{qDebug()<<studentnum<<Teacher<<Subject;
    ...
    foreach (QRadioButton* radioButton, radioButtons) {
        connect(radioButton, &QRadioButton::clicked, this, &Form2::handleRadioButtonClicked);
    }
}

void Form2::handleRadioButtonClicked()
{
...
void Form2::on_nextButton_clicked()
{
    ...
    QSqlQuery query(db);
    QString queryString = "UPDATE EVALUATIONDATA SET B = :average WHERE STUDENTNUMBER = :studentNumber AND TEACHER = :teacher AND SUBJECT = :subject";
